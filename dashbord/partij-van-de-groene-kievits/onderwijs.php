...
<body>
    ...
    <!-- WONEN -->
    <div class=container>
        <h3 class="d-flex justify-content-center font-weight-bold" style="margin-top: 50px; margin-bottom: 10px">Onderwijs</h3>
        <div class="d-flex justify-content-center text-center">
            <h6 class="col-lg-6 text-black font-weight-bold" style="margin-bottom: 30px">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem corrupti magnam aperiam et nam cum ducimus, similique dignissimos.</h6>
        </div>
    </div>
    <!-- WONEN -->
